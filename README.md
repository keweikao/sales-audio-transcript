# Sales Audio Transcript - Faster-Whisper 繁體中文版

iPhone 錄音優化的語音轉錄服務，使用 faster-whisper 本地處理，專門針對繁體中文進行優化。

## 🚀 主要特色

### 🎯 繁體中文優化
- **專用模型**: 使用 `asadfgglie/faster-whisper-large-v3-zh-TW` 繁體中文優化模型
- **強制繁體**: 使用繁體中文初始提示確保輸出格式
- **本地處理**: 完全移除 OpenAI API 依賴，降低成本
